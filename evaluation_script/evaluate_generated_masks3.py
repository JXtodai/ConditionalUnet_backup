...
def plot_combo_trends(width_real_central, width_gen_central, length_real_central, length_gen_central,
    ...
    """
    fig, axes = plt.subplots(1,3, figsize=(13,5), dpi=200)
    ...
    #)
    _plot_combo_center_axis(
        axes[1], width_real_central, width_gen_central,
    ...
    #)
    _plot_combo_center_axis(
        axes[2], max_length_real_central, max_length_gen_central,
    ...
    #)
    _plot_combo_center_axis(
        axes[0], overlap_real_central, overlap_gen_central,
...
def main():
    ...
    plot_combo_trends(
        ...
        max_length_trend_real, max_length_trend_gen,
        overlap_trend_real, overlap_trend_gen,
        output_dir / "combo_trends_3para.png",
    )
    ...
    if gen_combos:
        ...
        fig, axes = plt.subplots(3, n_combos, figsize=(4.5 * n_combos, 10), dpi=200, squeeze=False)
        ...
        plt.tight_layout()
        plt.savefig(output_dir / "distributions_per_combo_widthlength.png", bbox_inches="tight")
        plt.close(fig)
