...
OUTPUT_DIR="/home/jixi/project/genai/output_conditional_unet_aggexp_embed_overfit_addloss_cldice2"
LOGGING_DIR="runs"
...
MASK_RECONSTRUCTION_LOSS_WEIGHT=0.016
CLDICE_LOSS_WEIGHT=0.05
SOFT_CLDICE_ITERATIONS=10
RECONSTRUCTION_MAX_TIMESTEP=500
VALIDATION_SEED=0
...
CMD=(
  ...
  "/home/jixi/project/genai/diffusers/examples/unconditional_image_generation/train_conditional_crack_aggexp_embed_addloss_cldice.py"
  --image_dir "$IMAGE_DIR"
  --mask_dir "$MASK_DIR"
