...
OUTPUT_DIR="/home/jixi/project/genai/output_conditional_unet_aggexp_embed_full_x0pred_cldice6_baseline1"
LOGGING_DIR="runs"
...
########## (6) Loss / prediction (baseline 1: SNR-weighted MSE only, no aux losses) ##########
...
CMD=(
  ...
  "/home/jixi/project/genai/diffusers/examples/unconditional_image_generation/train_conditional_crack_aggexp_embed_x0pred_cldice6_baseline1.py"
  --image_dir "$IMAGE_DIR"
  --mask_dir "$MASK_DIR"
