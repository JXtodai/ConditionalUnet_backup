...
OUTPUT_DIR="/home/jixi/project/genai/output_conditional_unet_aggexp_embed_overfit_addloss"
LOGGING_DIR="runs"
...
MASK_RECONSTRUCTION_LOSS_WEIGHT=0.5
VALIDATION_SEED=0
...
CMD=(
  ...
  "/home/jixi/project/genai/diffusers/examples/unconditional_image_generation/train_conditional_crack_aggexp_embed_addloss.py"
  --image_dir "$IMAGE_DIR"
  --mask_dir "$MASK_DIR"
