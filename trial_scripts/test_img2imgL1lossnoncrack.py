...
def parse_args():
    ...
    parser.add_argument(
        "--model_dir",
        type=Path,
        default="/home/jixi/project/genai/output_img2img_maskL1loss/epoch-10",
    ...
    parser.add_argument("--output_dir", type=Path, default="/home/jixi/dataset/Diff_img2img/holdout_img2img_test_sigleimg", help="Folder to save generated images.")
    parser.add_argument("--caption_dir", type=Path, default=None, help="Optional folder with per-image prompt .txt files.")
    parser.add_argument("--prompt", default="add thin crack")
