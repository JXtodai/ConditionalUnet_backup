...
OUTPUT_DIR="/home/jixi/project/genai/output_conditional_unet_aggexp_embed_full_x0pred_cldice6_clean2"
LOGGING_DIR="runs"
...
AREA_MATCHING_WEIGHT=0            # keep so the model retains class-specific area
OVERLAP_MATCHING_WEIGHT=0        # NEW: per-sample |pred*agg - target*agg|; teaches the spatial co-occurrence
