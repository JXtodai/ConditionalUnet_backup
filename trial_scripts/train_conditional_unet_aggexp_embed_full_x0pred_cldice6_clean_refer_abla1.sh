...
OUTPUT_DIR="/home/jixi/project/genai/output_conditional_unet_aggexp_embed_full_x0pred_cldice6_clean_refer_abla1"
LOGGING_DIR="runs"
...
TRAIN_BATCH_SIZE=8
EVAL_BATCH_SIZE=8
NUM_EPOCHS=80                       # fine-tune budget: 40 ep * 63 optim_steps/ep = ~2.5k steps
...
AREA_MATCHING_WEIGHT=0.0            # keep so the model retains class-specific area
OVERLAP_MATCHING_WEIGHT=0.0         # NEW: per-sample |pred*agg - target*agg|; teaches the spatial co-occurrence
