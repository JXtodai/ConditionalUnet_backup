...
METADATA_CSV="/home/jixi/dataset/Train_conditionalUnet/metadata_from_jsonl.csv"
OUTPUT_DIR="/home/jixi/project/genai/output_conditional_unet_agg_mask_batch8"
LOGGING_DIR="runs"
...
CMD=(
  ...
  "/home/jixi/project/genai/diffusers/examples/unconditional_image_generation/train_conditional_crack_agg_mask.py"
  --image_dir "$IMAGE_DIR"
  --mask_dir "$MASK_DIR"
