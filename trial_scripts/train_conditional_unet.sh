...
OUTPUT_DIR="/home/jixi/project/genai/output_conditional_unet"
LOGGING_DIR="runs"
...
CMD=(
  ...
  /home/jixi/project/genai/diffusers/examples/unconditional_image_generation/train_conditional_crack_mask.py
  --image_dir "$IMAGE_DIR"
  --mask_dir "$MASK_DIR"
