...
OUTPUT_DIR="/home/jixi/project/genai/output_conditional_unet_aggexp_embed_overfit_x0pred_cldice4"
LOGGING_DIR="runs"
...
BCE_WEIGHT=0.3                      # demoted slightly to give clDice room
DICE_WEIGHT=0.3                     # demoted slightly to give clDice room
CLDICE_WEIGHT=0.5                   # promoted: clDice is the only line-topology signal
...
AGGREGATE_CHANNEL_DROPOUT=0.3       # break the "trace the aggregate boundary" leak from cldice2
...
CMD=(
  ...
  "/home/jixi/project/genai/diffusers/examples/unconditional_image_generation/train_conditional_crack_aggexp_embed_x0pred_cldice4.py"
  --image_dir "$IMAGE_DIR"
  --mask_dir "$MASK_DIR"
