...
OUTPUT_DIR="/home/jixi/project/genai/output_conditional_unet_aggexp_embed_overfit"
LOGGING_DIR="runs"
...
LOGGER="tensorboard"
THRESHOLD=0.5
RESUME_FROM_CHECKPOINT="output_conditional_unet_aggexp_embed_overfit/checkpoint-600"
