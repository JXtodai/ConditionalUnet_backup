...
OUTPUT_DIR="/home/jixi/project/genai/output_conditional_unet_aggexp_embed_full_x0pred_cldice7b_overlap10"
LOGGING_DIR="runs"
...
TRAIN_BATCH_SIZE=8
EVAL_BATCH_SIZE=8
NUM_EPOCHS=25                       # short fine-tune for the overlap-weight delta on top of cldice6
...
OVERLAP_MATCHING_WEIGHT=10.0        # SWEEP VARIABLE: doubled from cldice6's 5.0 to test whether more weight tightens spatial co-occurrence (try 3 / 5 / 10 / 20)
