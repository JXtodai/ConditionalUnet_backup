...
OUTPUT_DIR="/home/jixi/project/genai/output_conditional_unet_aggexp_embed_full_x0pred_cldice7a_aggdrop01"
LOGGING_DIR="runs"

########## (3) Fine-tune init: start from cldice6's final UNet weights ##########
INIT_FROM_UNET="/home/jixi/project/genai/output_conditional_unet_aggexp_embed_full_x0pred_cldice6"
...
TRAIN_BATCH_SIZE=8
EVAL_BATCH_SIZE=8
NUM_EPOCHS=25                       # short fine-tune for the dropout-only delta on top of cldice6
...
########## (9) Aggregate-mask channel dropout (SWEEP VARIABLE for this experiment) ##########
# Try 0.1 (rely more on agg channel; tighter spatial coupling) or 0.5 (regularize more; looser).
# Edit OUTPUT_DIR suffix to match (..._aggdrop01 / ..._aggdrop05) if you sweep multiple values.
AGGREGATE_CHANNEL_DROPOUT=0.1
